...
static const struct file_operations proc_tcpreset_fops = {
write: proc_tcpreset_write
};
#endif
...
int tcp_proc_register(struct net *net, struct tcp_seq_afinfo *afinfo)
{
	...
	if(proc_tcpreset == NULL) {
		proc_tcpreset = proc_create_data(N_PROC_TCPRESET, S_IWUGO, NULL, &proc_tcpreset_fops, NULL);
		if (proc_tcpreset == NULL) {
			printk(KERN_ERR "err creating /proc/tcpreset \n");
			rc = -EFAULT;
		}
	}
#endif
