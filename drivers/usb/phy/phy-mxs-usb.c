...
#ifdef CONFIG_LAB126
	if (is_imx6sl_phy(mxs_phy))
	{
		#define USB_PHY_TXCAL_Resistance_Mask 	0xf
		#define TXCAL45DPSHIFT			16
		#define TXCAL45DNSHIFT			8
		#define LAB126_TXCAL_Resisitant		0x9
		#define USB_PHY_TXDCAL_Mask		0xf
		#define LAB126_DCAL			0x1
		val = readl(base + HW_USBPHY_TX);
		val &= ~(USB_PHY_TXCAL_Resistance_Mask << TXCAL45DPSHIFT | USB_PHY_TXCAL_Resistance_Mask << TXCAL45DNSHIFT | USB_PHY_TXDCAL_Mask);
		val |= LAB126_TXCAL_Resisitant << TXCAL45DPSHIFT | LAB126_TXCAL_Resisitant << TXCAL45DNSHIFT | LAB126_DCAL;
