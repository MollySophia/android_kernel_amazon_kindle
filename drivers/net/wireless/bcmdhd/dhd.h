...
#define DHD_SCAN_PASSIVE_TIME		60 /* ms: Embedded default Passive setting from DHD */
#else /* !CONFIG_LAB126 */
...
/* Pattern Size + src ip addr len +
 * dts ip addr len + src port len + dts port len + 1
 */
#define CUSTOM_FILTER_SIZE		80
#define MAX_CUSTOM_FILTERS		5
#endif

#ifdef LAB126_TCPKEEPALIVE_SUPPORT
#define MAX_TCPKEEPALIVE_SESSIONS 4
typedef struct tcpka_conn_sess_info {
	uint32 sess_id;
	uint32 flag;
	uint16 ipid;
	uint32 seq;
...
#ifdef LAB126_SUPPORT_CUSTOM_PKTFILTER
	char *ipport_filterp[MAX_CUSTOM_FILTERS];
#endif
#endif
...
#endif
#ifdef LAB126_TCPKEEPALIVE_SUPPORT
	bool tcp_kepalive_set[MAX_TCPKEEPALIVE_SESSIONS];
	struct mutex tcpka_lock;
	tcpka_t tcpka[MAX_TCPKEEPALIVE_SESSIONS];
#endif
#if defined(WLTDLS) && defined(PCIE_FULL_DONGLE)
...
#ifdef LAB126_SUPPORT_CUSTOM_PKTFILTER
#define DHD_EAPOL_FILTER_NUM		6
#define DHD_CUSTOM_FILTER_1		7
#define DHD_CUSTOM_FILTER_2		8
#define DHD_CUSTOM_FILTER_3		9
#define DHD_CUSTOM_FILTER_4		10
#define DHD_CUSTOM_FILTER_5		11
#define DHD_MAX_FILTER_SUPPORT		12
#else
#define DHD_MAX_FILTER_SUPPORT		6
...
#ifdef LAB126_TCPKEEPALIVE_SUPPORT
int dhd_tcpka_conn_enable(dhd_pub_t *dhd, int sess_id, int enable);
