...
#define MACDBG_OBFUSCATE "%s:%s:%s:%s:%02x:%02x"
#define MAC2STRDBG_OBFUSCATE(ea) "xx", "xx", "xx", "xx", (ea)[4], (ea)[5]
#define MACDBG "%02x:%02x:%02x:%02x:%02x:%02x"
#define MAC2STRDBG(ea) (ea)[0], (ea)[1], (ea)[2], (ea)[3], (ea)[4], (ea)[5]
#else
#define MACDBG_OBFUSCATE    "%s:%02x:%02x"
#define MAC2STRDBG_OBFUSCATE(ea) "xx", (ea)[4], (ea)[5]
