...
static int __init imx2_wdt_probe(struct platform_device *pdev)
{
	...
	dev_info(&pdev->dev,
		"IMX2+ Watchdog Timer enabled. timeout=%ds (nowayout=%d) imx2_wdt.base=0x%x base pa:0x%x imx2_wdt.clk=0x%x\n",
			 imx2_wdt.timeout, nowayout, imx2_wdt.base, res->start, imx2_wdt.clk);
