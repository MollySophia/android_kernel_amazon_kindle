...
/**
	Read Jack Status register
	@param[in] codec - Handle to max98090 codec
	@return int -	0x06 No jack detected
			0x02 Microphone detetced
			0x00 Line In detected
*/
